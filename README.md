...
(Note that the model only conducted one epoch training and the more I trained, the worse the results were.) I think it's probably a hyperparameter problem.)
